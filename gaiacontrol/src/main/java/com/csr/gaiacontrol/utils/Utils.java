...
public final class Utils {
    ...
    public static BluetoothDevice getConnectedDeviceMAC() {
        ...
        while (iterator.hasNext()) {
            ...
            if (item.getName().equalsIgnoreCase("Omega Buttons") ||
                    item.getName().equalsIgnoreCase("Buttons with Omega") ||
                    item.getName().equalsIgnoreCase("Buttons")) {
    ...
    public static String getBatteryPercentage(int level) {
        int batteryPercentage = 0;
        batteryPercentage = ((level - Consts.BATTERY_LEVEL_MIN)*100) / (Consts.BATTERY_LEVEL_MAX - Consts.BATTERY_LEVEL_MIN);
