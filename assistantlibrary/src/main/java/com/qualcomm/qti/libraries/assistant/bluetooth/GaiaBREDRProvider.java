 ...
 */
public class GaiaBREDRProvider implements IvorManager.IvorManagerListener, GaiaLink.AssistantCallback {
    /**
    ...
    public GaiaBREDRProvider(@NonNull Handler listener, BluetoothManager manager) {
        ...
        mGaiaLink.setAssistantCallback(this);
        mListener = listener;
    }
    ...
    public boolean connect(@NonNull BluetoothDevice device) {
        return mGaiaLink.connect(device);
    }
    ...
    public void onConnectionStateChanged(@AssistantEnums.ConnectionState int state) {
    ...
    @Override // BREDRProvider
    public void onConnectionError(@AssistantEnums.DeviceError int error) {
    ...
    @Override // BREDRProvider
    public void onDataFound(byte[] data) {
    ...
    public boolean sendGAIAPacket(byte[] packet) {
        return mGaiaLink.sendData(packet);
    }
