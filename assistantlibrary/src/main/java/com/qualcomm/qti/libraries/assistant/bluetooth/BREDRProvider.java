...
/*package*/ abstract class BREDRProvider {
     ...
     */
    private static final boolean DEBUG_LOGS = AssistantConsts.Debug.BR_EDR_PROVIDER;
     ...
     */
    /*package*/ boolean connect(BluetoothDevice device) {
        if (DEBUG_LOGS) {
     ...
     */
    /*package*/ synchronized @AssistantEnums.ConnectionState int getState() {
        return mState;
    }
     ...
     */
    /*package*/ abstract void onConnectionStateChanged(@AssistantEnums.ConnectionState int state);

    /**
     * <p>When an error occurs related to the BR/EDR connection this method is called by this provider.</p>
     *
     * @param error The type of error which occurred. Please see {@link AssistantEnums.DeviceError} for more information.
     */
    /*package*/ abstract void onConnectionError(@AssistantEnums.DeviceError int error);
     ...
     */
    /*package*/ abstract void onCommunicationRunning();
     ...
     */
    /*package*/ abstract void onDataFound(byte[] data);
    ...
    private void onConnectionFailed() {
        ...
        onConnectionError(AssistantEnums.DeviceError.CONNECTION_FAILED);
    }
    ...
    private void onConnectionLost() {
        ...
        setState(AssistantEnums.ConnectionState.DISCONNECTED);
        // Dispatch the corresponding failure message
        onConnectionError(AssistantEnums.DeviceError.CONNECTION_LOST);
    }
