...
public class Gaia {
    ...
    */
    ...
    public static final int VENDOR_IAMPLUS = 0xFFFF;
    ...
    /**
     * Vendor ID IAMPLUS specific commands
     */
     ...
     * ******************************* */
    /**
     * Enables or disables the voice assistant command from headset.
     */
    public static final int COMMAND_SET_VOICE_ASSISTANT_CONFIG = 0x0201;
    /**
     * Enables or disables the Sensory from headset.
     */
    public static final int COMMAND_SET_SENSORY_CONFIG = 0x0203;

    /* ***********************************
     *    Status commands 0x03nn
     * *********************************** */

    /**
     * Requests the UUID of device. The acknowledgement payload contains 16 octets,
     * the headset copies fields from the Bluetooth Device UUID.
     */
    public static final int COMMAND_GET_UUID = 0x0301;
    /**
     * Request the SERIAL NUMBER value of device. The acknowledgement payload contains 20 octets,
     * the headset copies fields from the Bluetooth Device SERIAL NUMBER.
     */
    public static final int COMMAND_GET_SERIAL_NUMBER = 0x0302;

    public static final int GAIA_COMMAND_GET_FW_VERSION = 0x0303;
    /* *************************************
