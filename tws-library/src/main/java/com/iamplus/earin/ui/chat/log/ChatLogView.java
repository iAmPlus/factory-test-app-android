...
import com.iamplus.earin.ui.chat.log.items.ItemType;
...
public class ChatLogView extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
        ...
        if (itemType != null) {
            ...
            if(itemType == ItemType.MEMBER_EVENT) {
                holderView = li.inflate(R.layout.chat_log_event_holder, parent, false);
            } else if (itemType.isAgent()) {
