...
public class JellyBeanCapCommunicationController extends CapCommunicationController implements BluetoothAdapter.LeScanCallback
{
    private static final String TAG = JellyBeanCapCommunicationController.class.getSimpleName();
    ...
    protected void startScanning(final BluetoothAdapter adapter)
    {
        ...
        mainHandler.post(new Runnable()
        {
            public void run()
            {
                ...
                adapter.startLeScan(JellyBeanCapCommunicationController.this);
            }
        });
    }
    ...
    protected void stopScanning(final BluetoothAdapter adapter) {
        ...
        mainHandler.post(new Runnable() {
            public void run() {
                //Stop!
                adapter.stopLeScan(JellyBeanCapCommunicationController.this);
            }
        });
