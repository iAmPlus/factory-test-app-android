...
public class EqualizerActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void onClick(View v) {
        ...
        mButtonsManager.sendGaiaPacket(Gaia.COMMAND_SET_EQ_CONTROL, selectedPreset);
    }

    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        switch (buttonView.getId()) {
            case com.csr.gaiacontrol.R.id.sw_presets:
                mButtonsManager.sendGaiaPacket(Gaia.COMMAND_SET_USER_EQ_CONTROL, isChecked);
                if (isChecked) {
                    mButtonsManager.sendGaiaPacket(Gaia.COMMAND_GET_EQ_CONTROL);
                }
                else {
                    activatePresets(false);
                }
                break;
            case com.csr.gaiacontrol.R.id.sw_bass:
                mButtonsManager.sendGaiaPacket(Gaia.COMMAND_SET_BASS_BOOST_CONTROL, isChecked);
                break;
            case com.csr.gaiacontrol.R.id.sw_3d:
                mButtonsManager.sendGaiaPacket(Gaia.COMMAND_SET_3D_ENHANCEMENT_CONTROL, isChecked);
                break;
        }
    }
    ...
    protected void onResume() {
        ...
        if (mButtonsManager.getGaiaLink().isConnected()) {
            ...
            mButtonsManager.sendGaiaPacket(Gaia.COMMAND_GET_3D_ENHANCEMENT_CONTROL);
            mButtonsManager.sendGaiaPacket(Gaia.COMMAND_GET_BASS_BOOST_CONTROL);
            mButtonsManager.sendGaiaPacket(Gaia.COMMAND_GET_USER_EQ_CONTROL);
        }
        else {
            this.finish();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.csr.gaiacontrol.R.layout.activity_equalizer);
        this.init();
    }
    ...
    private void init() {
        ...
        PresetButton buttonClassic = (PresetButton) findViewById(com.csr.gaiacontrol.R.id.bt_preset_6);
        buttonClassic.setOnClickListener(this);
        mPresets[buttonClassic.getPreset()] = buttonClassic;

        PresetButton buttonPop = (PresetButton) findViewById(com.csr.gaiacontrol.R.id.bt_preset_5);
        buttonPop.setOnClickListener(this);
        mPresets[buttonPop.getPreset()] = buttonPop;

        PresetButton buttonRock = (PresetButton) findViewById(com.csr.gaiacontrol.R.id.bt_preset_2);
        buttonRock.setOnClickListener(this);
        mPresets[buttonRock.getPreset()] = buttonRock;

        PresetButton buttonJazz = (PresetButton) findViewById(com.csr.gaiacontrol.R.id.bt_preset_3);
        buttonJazz.setOnClickListener(this);
        mPresets[buttonJazz.getPreset()] = buttonJazz;

        PresetButton buttonFolk = (PresetButton) findViewById(com.csr.gaiacontrol.R.id.bt_preset_4);
        buttonFolk.setOnClickListener(this);
        mPresets[buttonFolk.getPreset()] = buttonFolk;

        PresetButton buttonDefault = (PresetButton) findViewById(com.csr.gaiacontrol.R.id.bt_preset_0);
        buttonDefault.setOnClickListener(this);
        mPresets[buttonDefault.getPreset()] = buttonDefault;

        PresetButton buttonCustom = (PresetButton) findViewById(com.csr.gaiacontrol.R.id.bt_preset_1);
        buttonCustom.setOnClickListener(this);
        mPresets[PresetButton.PRESET_CUSTOM] = buttonCustom;

        mSwitchPresets = (Switch) findViewById(com.csr.gaiacontrol.R.id.sw_presets);
        mSwitchPresets.setOnCheckedChangeListener(this);
        mSwitch3D = (Switch) findViewById(com.csr.gaiacontrol.R.id.sw_3d);
        mSwitch3D.setOnCheckedChangeListener(this);
        mSwitchBass = (Switch) findViewById(com.csr.gaiacontrol.R.id.sw_bass);
        mSwitchBass.setOnCheckedChangeListener(this);

        mButtonConfigure = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_configure_bank_1);
    ...
    private void activatePresets (boolean activate) {
        ...
        findViewById(com.csr.gaiacontrol.R.id.tl_presets).setVisibility(visibility);
    ...
    private void receivePacketCommandNotSupported(GaiaPacket packet) {
        switch (packet.getCommand()) {
            ...
            case Gaia.COMMAND_SET_EQ_CONTROL:
                ...
                findViewById(com.csr.gaiacontrol.R.id.tv_info_custom).setVisibility(View.VISIBLE);
                break;
            case Gaia.COMMAND_GET_3D_ENHANCEMENT_CONTROL:
            case Gaia.COMMAND_SET_3D_ENHANCEMENT_CONTROL:
                mSwitch3D.setVisibility(View.GONE);
                findViewById(com.csr.gaiacontrol.R.id.tv_info_3D).setVisibility(View.VISIBLE);
                break;
            case Gaia.COMMAND_GET_BASS_BOOST_CONTROL:
            case Gaia.COMMAND_SET_BASS_BOOST_CONTROL:
                mSwitchBass.setVisibility(View.GONE);
                findViewById(com.csr.gaiacontrol.R.id.tv_info_bass_boost).setVisibility(View.VISIBLE);
                break;
        }
    }
