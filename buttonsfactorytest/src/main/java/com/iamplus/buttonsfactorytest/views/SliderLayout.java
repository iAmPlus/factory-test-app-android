...
public class SliderLayout extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        mSeekBar = (SeekBar) findViewById(com.csr.gaiacontrol.R.id.sb_slider);
        mTVValue = (TextView) findViewById(com.csr.gaiacontrol.R.id.tv_value);
        mTVTitle = (TextView) findViewById(com.csr.gaiacontrol.R.id.tv_title);
        mTVMinValue = (TextView) findViewById(com.csr.gaiacontrol.R.id.tv_slider_min_value);
        mTVMaxValue = (TextView) findViewById(com.csr.gaiacontrol.R.id.tv_slider_max_value);
    }
