...
import com.iamplus.buttonsfactorytest.equalizer.Band;
import com.iamplus.buttonsfactorytest.equalizer.Bank;
import com.iamplus.buttonsfactorytest.equalizer.parameters.Filter;
import com.iamplus.buttonsfactorytest.equalizer.parameters.Parameter;
import com.iamplus.buttonsfactorytest.equalizer.parameters.ParameterType;
import com.iamplus.buttonsfactorytest.views.PresetButton;
import com.iamplus.buttonsfactorytest.views.SliderLayout;
 ...
 */
public class CustomEqualizerActivity extends AppCompatActivity implements SliderLayout.SliderListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.csr.gaiacontrol.R.menu.custom_equaliser_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case com.csr.gaiacontrol.R.id.action_refresh_equaliser:
            refreshValues();
            return true;
        default:
    ...
    protected void onResume() {
        super.onResume();
        mButtonsManager.getGaiaLink().setReceiveHandler(new CustomEqualizerActivity.GaiaHandler(this));
        refreshValues();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.csr.gaiacontrol.R.layout.activity_custom_equalizer);
        this.init();
    }
    /**
    ...
    private void refreshValues() {
        ...
        mButtonsManager.sendGaiaPacket(Gaia.COMMAND_GET_EQ_CONTROL); // to know if the current pre-set is the custom one.
    }
    ...
    private void init() {
        ...
        this.getSupportActionBar().setLogo(com.csr.gaiacontrol.R.drawable.ic_equalizer_small);
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        mProgressLayout = findViewById(com.csr.gaiacontrol.R.id.l_progress_bar);
    ...
    private void initSettingsComponents() {
        mSLFrequency = (SliderLayout) findViewById(com.csr.gaiacontrol.R.id.sl_frequency);
        mSLFrequency.initialize(getString(com.csr.gaiacontrol.R.string.frequency_title),
                mBank.getCurrentBand().getFrequency().getLabelValue(), this);
        mSLGain = (SliderLayout) findViewById(com.csr.gaiacontrol.R.id.sl_gain);
        mSLGain.initialize(getString(com.csr.gaiacontrol.R.string.gain_title), mBank.getCurrentBand().getGain().getLabelValue(), this);
        mSLQuality = (SliderLayout) findViewById(com.csr.gaiacontrol.R.id.sl_quality);
        mSLQuality.initialize(getString(com.csr.gaiacontrol.R.string.quality_title), mBank.getCurrentBand().getQuality().getLabelValue(),
                this);
        mSLMasterGain = (SliderLayout) findViewById(com.csr.gaiacontrol.R.id.sl_master_gain);
    ...
    private void initFiltersComponents() {
        mFilters[Filter.BYPASS.ordinal()] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_BYPASS);
        ...
        mFilters[Filter.LOW_PASS_1.ordinal()] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_LPF1);
        ...
        mFilters[Filter.HIGH_PASS_1.ordinal()] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_HPF1);
        ...
        mFilters[Filter.ALL_PASS_1.ordinal()] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_APF1);
        ...
        mFilters[Filter.LOW_SHELF_1.ordinal()] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_LS1);
        ...
        mFilters[Filter.HIGH_SHELF_1.ordinal()] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_HS1);
        ...
        mFilters[Filter.TILT_1.ordinal()] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_Tilt1);
        ...
        mFilters[Filter.LOW_PASS_2.ordinal()] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_LPF2);
        ...
        mFilters[Filter.HIGH_PASS_2.ordinal()] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_HPF2);
        ...
        mFilters[Filter.ALL_PASS_2.ordinal()] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_APF2);
        ...
        mFilters[Filter.LOW_SHELF_2.ordinal()] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_LS2);
        ...
        mFilters[Filter.HIGH_SHELF_2.ordinal()] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_HS2);
        ...
        mFilters[Filter.TILT_2.ordinal()] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_Tilt2);
        ...
        mFilters[Filter.PARAMETRIC_EQUALIZER.ordinal()] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_PEQ);
    ...
    private void initBandsComponents() {
        mBandButtons[1] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_band_1);
        ...
        mBandButtons[2] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_band_2);
        ...
        mBandButtons[3] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_band_3);
        ...
        mBandButtons[4] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_band_4);
        ...
        mBandButtons[5] = (Button) findViewById(com.csr.gaiacontrol.R.id.bt_band_5);
    ...
    private void sendGetEQParameterPacket(int band, int parameter) {
        ...
        mButtonsManager.sendGaiaPacket(Gaia.COMMAND_GET_EQ_PARAMETER, EQ_PARAMETER_FIRST_BYTE, value);
    }
    ...
    private void sendSetEQParameterPacket(int band, int parameter, int value) {
        ...
        mButtonsManager.sendGaiaPacket(Gaia.COMMAND_SET_EQ_PARAMETER, payload);
    }
    ...
    private void buildDialogs() {
        ...
        incorrectStateDialogBuilder.setTitle(getString(com.csr.gaiacontrol.R.string.dialog_incorrect_state_title));

        incorrectStateDialogBuilder.setMessage(getString(com.csr.gaiacontrol.R.string.dialog_incorrect_state_message));
        incorrectStateDialogBuilder.setPositiveButton(getString(com.csr.gaiacontrol.R.string.alert_ok),
    ...
    private static class GaiaHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case DISCONNECTED:
                ...
                Toast.makeText(parentActivity, com.csr.gaiacontrol.R.string.toast_disconnected, Toast.LENGTH_SHORT).show();
